...
const personas = [
  {
    ...
    name: "Sarah",
    pain: "40% of her day answering the same questions.",
    solution: "The team queries the Chat instead of pinging Sarah. She reclaims 6 hours/week.",
  ...
  },
  {
    ...
    role: "Engineers",
    name: "Leo",
    pain: "Afraid to ask 'dumb questions.' Jira tickets are too sparse.",
    solution: "Decision History shows the 'why' behind the code with source links. No judgement, full context.",
  ...
  },
  {
    ...
    role: "Executives",
    name: "Elena",
    pain: "'Everything is on track' — then projects slip.",
    solution: "Risk Heatmap flags dependency bottlenecks from Slack sentiment before they become crises.",
