    ...
    <div className="container mx-auto px-6 relative z-10 text-center">
      ...
      >
        ...
        <p className="text-sm sm:text-base md:text-lg text-primary-foreground/60 leading-relaxed mb-8 md:mb-10 max-w-xl mx-auto">
          Stop chasing your highest paid engineers and directors for portfolio health questions. Agilow unifies scattered data and gives you accurate forecasting insights at your fingertips.
        </p>
