...
const features = [
  {
    icon: Layers,
    title: "Institutional Memory, Automatically Preserved.",
    description: "Pulls context from Slack, Jira, email, and meetings into one place — preserving the knowledge that's vital for GxP and audit trails, without manual documentation.",
    badge: "Context Engine",
    mockup: <AggregationMockup />,
  },
  {
    icon: BarChart3,
    title: "Spot Project Drift Before it Impacts Your Launch.",
    description: "See where your team's time actually goes — not just what's logged in a ticket. Surface technical bottlenecks and rising risk before they delay a launch.",
    badge: "Strategic Insights",
    mockup: <DashboardMockup />,
  },
  {
    icon: MessageSquareText,
    title: "Search Your Decision History, Not Your Slack.",
  ...
  {
    icon: History,
    title: "A Searchable Archive of Every R&D Pivot.",
